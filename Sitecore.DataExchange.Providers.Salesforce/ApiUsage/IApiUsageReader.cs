...
// Type: Sitecore.DataExchange.Providers.Salesforce.ApiUsage.IApiUsageReader
...
{
  public interface IApiUsageReader
  {
    ApiUsageDetails GetApiUsageDetails(AuthenticationClient client);
  }
}
